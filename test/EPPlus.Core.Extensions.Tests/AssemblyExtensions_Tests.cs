...
namespace EPPlus.Core.Extensions.Tests
{
    public class AssemblyExtensions_Tests
    {
        ...
        public void Should_get_a_type_from_name()
        {
            ...
            //-----------------------------------------------------------------------------------------------------------
            Assembly executingAssembly = Assembly.GetExecutingAssembly();
            string nameOfFirstType = executingAssembly.GetNamesOfAllExcelExportableClasses().First();
        ...
        [Fact]
        public void Should_get_names_of_all_ExcelExportable_marked_classes()
        {
            //-----------------------------------------------------------------------------------------------------------
            // Arrange
            //-----------------------------------------------------------------------------------------------------------
            ...
            // Act
            //-----------------------------------------------------------------------------------------------------------
            List<string> results = executingAssembly.GetNamesOfAllExcelExportableClasses();
